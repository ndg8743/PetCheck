...
export const DrugSearchPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-navy-900">
      ...
      {showCompareBar && (
        <div className="sticky bottom-0 left-0 right-0 z-30 border-t border-gray-200 dark:border-navy-700 bg-white/95 dark:bg-navy-800/95 backdrop-blur-sm shadow-elevated">
